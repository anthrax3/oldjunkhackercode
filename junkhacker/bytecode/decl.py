...
class Declaration(object):
  ...
  def __init__(self, kind, code_object):
    self.kind = kind
  ...
  def add_child(self, child):
    ...
    self.children = sorted(self.children, key=methodcaller('get_start_lineno'))
  ...
  def update_nested_code_object(self, original_co, new_co):
    self.code_object = update_nested_code_object(self.code_object,
                                                  original_co,
                                                  new_co)
...
class ImportDeclaration(Declaration):
  ...
  def __repr__(self):
    ...
    # return 'Import(%s), self.aliases is (%s)' % import_buffer, self.aliases
...
class ModuleDeclaration(Declaration):
  ...
  def __repr__(self):
    return 'ModuleDeclaration(path=%s, co=%s, imports=%s)' % (self.module_path, self.code_object, self.imports)
...
class MethodDeclaration(Declaration):
  ...
  def __repr__(self):
    return 'MethodDeclaration#%d(name=%s, args=%s, pretty_summary=%s, one_param_summary=%s, all_params_vuln_summary=%s all_params_returns_tainted=%s)' \
           % (self.start_lineno, self.method_name, self.formal_parameters, self.pretty_summary, self.one_param_summary, self.all_params_vuln_summary, self.all_params_returns_tainted)
